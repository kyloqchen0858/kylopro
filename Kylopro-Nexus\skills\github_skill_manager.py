...
def test_skill_manager():
    ...
    try:
        ...
        # 测试2: 搜索技能（模拟）
        print("\n2. 测试技能搜索:")
        # 注意：实际搜索需要有效的token和仓库
        # skill_info = manager.search_skill("weather")
        # if skill_info:
        #     print(f"   找到技能: {skill_info.name}")
        # else:
        #     print("   搜索测试跳过（需要有效token）")
...
'''
        ...
        # 注意：实际上传需要有效的token
        # success = manager.upload_skill("test_skill", test_skill_code)
        # print(f"   上传测试: {'成功' if success else '失败'}")
        print("   上传测试跳过（保护敏感信息）")
        ...
        # 测试5: 备份技能
        print("\n5. 测试技能备份:")
        success = manager.backup_skills()
        print(f"   备份测试: {'成功' if success else '失败'}")
